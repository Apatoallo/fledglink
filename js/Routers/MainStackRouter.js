...
const NotificationStack = createStackNavigator(
  {
    ...
    FlAnnounceNotif: {
      screen: FlAnnounceNotification,
      navigationOptions: {
        title: "Fledglink Message",
        ...navigationOptions
      }
    }
  },
...
//   return (
//     <NativeBaseProvider>
//       {props.authType === authTypes.UNAUTHORIZED && <AuthNav />}
//       {props.authType === authTypes.AUTHORIZED && (
//         <StackNav
//           uriPrefix={prefix}
//           initialRoute={props.initialRoute}
//           profileSetUp={props.profileSetUp}
//         />
//       )}
//       <Modal animationType="slide" transparent visible={props.networkModal}>
//         <ImageBackground
